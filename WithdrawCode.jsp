...
<%
long account_no=Long.parseLong(request.getParameter("w1"));
String name=request.getParameter("w2");
String password=request.getParameter("w3");
double amount=Double.parseDouble(request.getParameter("w4"));
...
try{
	...
	out.print("Your balance is Decrease"+" "+amount);
